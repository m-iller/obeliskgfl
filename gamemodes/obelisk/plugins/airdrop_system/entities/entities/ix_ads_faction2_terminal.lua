...
ENT.PrintName = "Консоль вызова аирдропов (Фракция 2)"
ENT.Author = "kido"
ENT.Spawnable = true
ENT.AdminOnly = true
...
if CLIENT then
    function ENT:Draw()
        ...
        cam.Start3D2D(pos, ang, 0.1)
            ...
            local factionConfig = ix.configs.airbrop.factions["faction2"]
            local factionName = factionConfig and factionConfig.name or "ФРАКЦИЯ 2"
            
            draw.SimpleText("КОНСОЛЬ ВЫЗОВА", "ADS_RobotoLarge", 0, -60, Color(156, 39, 176), TEXT_ALIGN_CENTER)
            draw.SimpleText("АИРДРОПОВ", "ADS_RobotoMedium", 0, -30, Color(156, 39, 176), TEXT_ALIGN_CENTER)
            draw.SimpleText(factionName, "ADS_RobotoMedium", 0, 0, Color(255, 193, 7), TEXT_ALIGN_CENTER)

...
ENT.PrintName = "Лог терминал воздушной техники"
ENT.Author = "kido"
ENT.Spawnable = true
ENT.AdminOnly = true
ENT.Category = "VCS"
...
if SERVER then
    function ENT:Initialize()
        self:SetModel("models/reizer_props/srsp/sci_fi/console_02_1/console_02_1.mdl")
    ...
    function ENT:Use(activator, caller)
        ...
        local message = plyName .. " подключается к лог терминалу воздушной техники."
    ...
    function ENT:Draw()
        ...
        if distance < 500 then
            cam.Start3D2D(pos, ang, 0.1)
                -- Рисуем название
                draw.SimpleText("Лог терминал воздушной техники", "DermaLarge", 0, 0, Color(0, 255, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
